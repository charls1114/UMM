...
void CBottomBarWndUI::Notify(TNotifyUI& msg)
{
	if (msg.sType == _T("click"))
	{
		...
		////////////////////////////////////////////////////////
		else if (msg.pSender->GetName() == _T("btn_chat_close"))
		{
			DoCloseChatBtnClick();
		}
		else if (msg.pSender->GetName() == _T("btn_chat_open"))
		{
			DoOpenChatBtnClick();
		}
...
{
	CMainFrame::GetInstance().RemoveChatContentWnd();
	chat_close_->SetVisible(false);
	chat_open_->SetVisible(true);
}

void CBottomBarWndUI::DoOpenChatBtnClick(){
